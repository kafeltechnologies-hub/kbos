...
<head>
    <meta charset="utf-8">
    <title>Material Issue Voucher - {{ $transaction->transaction_no }}</title>
...
<div class="no-print">
    <button onclick="window.print()">Print Material Issue Voucher</button>
</div>
...
<div class="header">
    ...
    <div class="title">MATERIAL ISSUE VOUCHER</div>
</div>

<div class="grid">
    <div class="box">
        <div class="label">Issue No.</div>
    ...
    <div class="box">
        ...
        <div class="value">{{ $transaction->project?->project_name ?? '-' }}</div>
    </div>

    <div class="box">
        <div class="label">Project Code</div>
        <div class="value">{{ $transaction->project?->project_code ?? '-' }}</div>
    </div>
    ...
    <div class="box">
        ...
        <div class="value">{{ $transaction->waybill?->waybill_no ?? '-' }}</div>
    </div>
</div>
...
<div class="signatures">
    ...
    <div class="signature">
        Received By
        <small>Site Representative</small>
    </div>
